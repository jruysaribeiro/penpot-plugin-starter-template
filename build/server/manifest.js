...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-D_TRvXUc.js')),
			__memo(() => import('./chunks/1-CKH46aNf.js')),
			__memo(() => import('./chunks/2-Bfrv-wKa.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-DSHMtzcd.js'))
			}
		],
